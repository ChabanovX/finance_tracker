...
mixin _$AccountDto {
 ...
 int get id; int get userId; String get name;@StringToDoubleConverter() double get balance; String get currency; DateTime get createdAt; DateTime get updatedAt;
...
@useResult
$Res call({
 int id, int userId, String name,@StringToDoubleConverter() double balance, String currency, DateTime createdAt, DateTime updatedAt
});
...
class _AccountDto implements AccountDto {
  const _AccountDto({required this.id, required this.userId, required this.name, @StringToDoubleConverter() required this.balance, required this.currency, required this.createdAt, required this.updatedAt});
